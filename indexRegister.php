<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if ($sql) {
            echo "<script>alert('Registor Successfull');</script>";
...
<html>
    <head>
        ...
        <script>
            function checkusername(val){
              $.ajax({
                  type:'POST'
                  url:'checkuser_availble.php'
                  data: 'username='+val,
                  success: function(data){
                     $('#usernameavailble').html(data);
                  }
              });
            }
        </script>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="username" placeholder="username" name="username" onblur="checkusername(this.value)" >
